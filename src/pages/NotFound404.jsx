    ...
    <StyledWrapper>
      <div className="container">
        ...
        <div className="message-container">
          <h1 className="message-title">Oops! Link Not Found</h1>
          <p className="message-text">
            The shortlink you're looking for doesn't exist or may have been removed.
          </p>
...
const StyledWrapper = styled.div`
  ...
  background: linear-gradient(135deg, #FFFAEB 0%, #f5f5f5 100%);
  padding: 1rem;
  overflow: hidden;
